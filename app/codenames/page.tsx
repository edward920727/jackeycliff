        ...
        <div className="space-y-4 sm:space-y-5 md:space-y-6">
          <div>
            ...
            <input
              ...
              placeholder="例如: 小明"
              className="w-full bg-gray-700 border border-gray-600 rounded-lg px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text白 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              maxLength={20}
            />
          </div>
